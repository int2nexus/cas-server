...
- [아키텍처](https://github.com/int2nexus/cas-server/blob/cas-server-0.1.29/charts/cas-server/docs/architecture.md)
  — 스토리지 모델(CAS·dedup·GC), 백엔드 구성, S3 호환 API 명세, 에러 코드
- [사용법](https://github.com/int2nexus/cas-server/blob/cas-server-0.1.29/charts/cas-server/docs/usage.md)
...
방법은 [`examples/sealed-secret.yaml`](https://github.com/int2nexus/cas-server/blob/cas-server-0.1.29/charts/cas-server/examples/sealed-secret.yaml) 참고.
...
`values-prod.yaml`은 직접 작성하거나 [`examples/values-prod.yaml`](https://github.com/int2nexus/cas-server/blob/cas-server-0.1.29/charts/cas-server/examples/values-prod.yaml)을
